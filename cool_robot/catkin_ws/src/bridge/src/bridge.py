...
import rospy
import os
from std_msgs.msg import Int16, Float64,Int32MultiArray,Float32MultiArray
...
class_type = {'Int16': Int16, 'Image': Image, 'Joy': Joy, 'PointCloud2':PointCloud2,
              ...
              'Marker': Marker, 'Path': Path, 'MarkerArray': MarkerArray, 'Int32MultiArray':Int32MultiArray,'Float32MultiArray':Float32MultiArray}


class Bridge(object):
    def __init__(self, ip):
        self.bridge_type = rospy.get_param('~bridge_type', '/bridge_type')
